...
<body>
    ...
    <form action="Repoter_Pending_Post.php" method="post" enctype="multipart/form-data">
        ...
        $variable_1 = "SELECT *FROM news_pending WHERE Post_ID = '$post_Id' AND Reporter_Can_Edit = '1'";
        ...
        if ($variable_3) {
            foreach ($variable_3 as $variable_4) {
                ...
                $Set_Date = $variable_4['Calendar_Date'];
                $cateory = $variable_4['News_Category'];
        ...
        <div style='display: flex; justify-content: space-between; margin-top: 15px;'>
            ...
            <select name='Type'  class='input-field' required>
                        <option value='' disable hiddenn required>$cateory</option>
        ...
        <div style=' margin-bottom: 150px; margin-top: 100px; text-align: end; margin-right: 50px; display: flex; justify-content: flex-end;'>
            <input type='submit' value='Draft' class='write-btn' style='background-color: #45ADA8EB;' name='Draft_Pending_NE' >
                    ...
                    <div class='content_body popup_set_time_body'>
                        ...
                        <div class='popup_form'>
                            ...
                            <div class='btn_set_option'>
                                ...
                                <input type='submit' name='Pending_NE_Without_Time_Edit' value='Publish Now' class='select_option' style='border: none; font-size: 15px;'>
                ...
                <div class='content popup_set_time' style='width: 300px; height: 310px;'>
                    ...
                    <div class='content_body popup_set_time_body'>
                        ...
                        <div class='popup_form'>
                            ...
                            <input type='submit' value='Set' name='Pending_NE_With_Time_Edit' class='update_btn' style='border: none;'>
