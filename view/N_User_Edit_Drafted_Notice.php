...
<body>
    ...
    $variable_1 = "SELECT *FROM notices_drafted WHERE Post_Id = '$post_Id' ";
    $variable_2 = $conn->query($variable_1);
    $variable_3 = $variable_2->fetchAll(PDO::FETCH_ASSOC);
    ...
    if ($variable_3) {
        ...
        <div style=' margin-bottom: 150px; margin-top: 60px; text-align: end; margin-right: 50px; display: flex; justify-content: flex-end;'>
            <input type='submit' value='Draft' class='write-btn' style='background-color: #45ADA8EB;' name='Draft_Drafted_NO' >
                    ...
                    <div class='content_body popup_set_time_body'>
                        ...
                        <div class='popup_form'>
                            ...
                            <div class='btn_set_option'>
                                ...
                                <input type='submit' name='Pend_Drafted_NO_Without_Date' value='Publish Now' class='select_option' style='border: none; font-size: 15px;'>
                ...
                <div class='content popup_set_time' style='width: 300px; height: 310px;'>
                    ...
                    <div class='content_body popup_set_time_body'>
                        ...
                        <div class='popup_form'>
                            ...
                            <input type='submit' value='Set' name='Pend_Drafted_NO_With_Date' class='update_btn' style='border: none;'>
