...
<div class="posts_content_view_body">
    ...
    <div class="button-set">
        <div class="view_btn back_btn" onclick="window.open('./Moderator_View_Articles.php', '_self')">Back</div>
    </div>
</div>
          ...
          <div class="content_body popup_set_time_body">
              ...
              <div class="popup_form">
                  ...
                  <form action="" method="post">
                    ...
                    <br>
                    <div class="publish_btn" onclick="window.open('Moderator_read_notice.php','_self')">Set</div>
