...
<head>
    <title>Edit Commercial Advertisement</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div style="display: flex; justify-content: space-between; margin-top: 15px;">
        ...
        <div style="width: 80%; ">
            ...
            $variable_1 = "SELECT *FROM drafted_post_area WHERE Post_Id = '$post_Id' ";
    ...
    $variable_1 = "SELECT *FROM job_vacancies_drafted WHERE Post_Id = '$post_Id' ";
    $variable_2 = $conn->query($variable_1);
    $variable_3 = $variable_2->fetchAll(PDO::FETCH_ASSOC);

    if ($variable_3) {
        foreach ($variable_3 as $variable_4) {
            $Company_Name = $variable_4['Company'];
            $Position = $variable_4['Position'];
            $Deadline_Date = $variable_4['Deadline_Date'];
        ...
        <div style='display: flex; justify-content: space-between; margin-top: 15px;'>
            ...
            <div style='width: 80%;'>
                <input type='text' class='input-field' name='Company_Name' value='$Company_Name' required>
            </div>
        </div>
        ...
        <div style='display: flex; justify-content: space-between; margin-top: 15px;'>
            ...
            <div style='width: 80%;'>
                <input type='text' class='input-field' name='Position' value='$Position' required>
            </div>
        </div>
        ...
        <div style='display: flex; justify-content: space-between; margin-top: 15px;'>
            ...
            <div style='width: 80%;'>
                <input type='date' class='input-field' name='Deadline_Date' value='$Deadline_Date' required>
            </div>
        </div>
        ...
        <div style=' margin-bottom: 150px; margin-top: 40px; text-align: end; margin-right: 50px; display: flex; justify-content: flex-end;'>
            <input type='submit' value='Draft' class='write-btn' style='background-color: #45ADA8EB;' name='Draft_Drafted_JV' >
                    ...
                    <div class='content_body popup_set_time_body'>
                        ...
                        <div class='popup_form'>
                            ...
                            <div class='btn_set_option'>
                                ...
                                <input type='submit' name='Pend_Drafted_JV_Without_Date' value='Publish Now' class='select_option' style='border: none; font-size: 15px;'>
                ...
                <div class='content popup_set_time' style='width: 300px; height: 310px;'>
                    ...
                    <div class='content_body popup_set_time_body'>
                        ...
                        <div class='popup_form'>
                            ...
                            <input type='date' name='Set_Date' id='new-date' class='inp inp1' value='00-00-0000'>
                            <br>
                            <br>

                            <label for='new-time' class='lbl'> Time</label>

                            <input type='time' name='Set_Time' id=new-time class='inp inp1' value='00-00'>
                            <br>
                            <!--<div class='update_btn' onclick='window.open('N_User_Pending_Posts.php','_self')'>Set</div>-->
                            <input type='submit' value='Set' name='Pend_Drafted_JV_With_Date' class='update_btn' style='border: none;'>
