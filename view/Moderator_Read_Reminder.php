...
<div class="posts_content_view_body">
    ...
    <div class="body_information">
          ...
          <div class="box-container">
              ...
              <div class="more" style="margin-right:8rem;margin-top:0.5rem;">
              ...
              <div class="setting_close" style="margin-top:2rem;padding-bottom:10rem;">
               <img src="../images/Setting.svg" alt="" srcset="" onclick="set_time_to_publish_Popup()">
    ...
    <div class="button-set">
        <div class="view_btn back_btn" onclick="window.open('./Moderator_Reminder.php', '_self')">Back</div>
    </div>
</div>
          ...
          <div class="content_body popup_set_time_body">
              ...
              <div class="popup_form">
                  ...
                  <form action="" method="post">
                    ...
                    <input type="date" name="" id="new-date" class="inp inp1" value="2022-11-05">
                      <br>
                      <br>

                    <label for="new-time" class="lbl"> Time</label>
                  
                    <input type="time" name="" id="new-time" class="inp inp1" value="08:00">
                    <br>
                    <div class="publish_btn" onclick="window.open('Moderator_Read_Reminder.php','_self')">Update</div>
