...
<body>
    ...
    <form action="N_User_Pending_Posts.php" method="post" enctype="multipart/form-data">
        ...
        $variable_1 = "SELECT *FROM news_drafted WHERE Post_ID = '$post_Id'";
        ...
        <div style=' margin-bottom: 150px; margin-top: 100px; text-align: end; margin-right: 50px; display: flex; justify-content: flex-end;'>
            <input type='submit' value='Draft' class='write-btn' style='background-color: #45ADA8EB;' name='Draft_Drafted_NE' >
                    ...
                    <div class='content_body popup_set_time_body'>
                        ...
                        <div class='popup_form'>
                            ...
                            <div class='btn_set_option'>
                                ...
                                <input type='submit' name='Pend_Drafted_NE_Without_Date' value='Publish Now' class='select_option' style='border: none; font-size: 15px;'>
                ...
                <div class='content popup_set_time' style='width: 300px; height: 310px;'>
                    ...
                    <div class='content_body popup_set_time_body'>
                        ...
                        <div class='popup_form'>
                            ...
                            <input type='submit' value='Set' name='Pend_Drafted_NE_With_Date' class='update_btn' style='border: none;'>
