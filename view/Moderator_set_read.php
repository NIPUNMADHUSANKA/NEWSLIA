...
<div class="posts_content_view_body">
    ...
    <div class="body_information">
          ...
          <div class="box-container">
              ...
              <div class="more" style="margin-top:0.8rem;">
                  <h4 style="margin-right:0rem;width:10rem;">Happy New Year</h4>
                  <p>2022:01:01</p>
                  <p>00:00</p>
              </div>
          ...
          <div class="content_body popup_set_time_body">
              ...
              <div class="popup_form">
                  ...
                  <form action="" method="post">
                    ...
                    <input type="date" name="" id="new-date" class="inp inp1" value="2022-01-01">
                      <br>
                      <br>
                    ...
                    <br>
                    <div class="publish_btn" onclick="window.open('Moderator_Set_Time.php','_self')">Update</div>
