...
<body>
    ...
    <div style="display: flex; justify-content: space-between; margin-top: 15px;">
        ...
        <div style="width: 80%; ">
            ...
            $variable_1 = "SELECT *FROM pending_post_area WHERE Post_ID = '$post_Id' ";
    ...
    $variable_1 = "SELECT *FROM job_vacancies_pending WHERE Post_ID = '$post_Id' AND System_User_Can_Edit = '1'";
    $variable_2 = $conn->query($variable_1);
    $variable_3 = $variable_2->fetchAll(PDO::FETCH_ASSOC);
    ...
    if ($variable_3) {
        foreach ($variable_3 as $variable_4) {
            ...
            $Set_Date = $variable_4['Set_Date'];
            $Set_Time = $variable_4['Set_Time'];
        ...
        <input type='submit' value='Draft' class='write-btn' style='background-color: #45ADA8EB;' name='Draft_Pending_JV' >
                    ...
                    <div class='content_body popup_set_time_body'>
                        ...
                        <div class='popup_form'>
                            ...
                            <div class='btn_set_option'>
                                ...
                                <input type='submit' name='Pending_JV_Without_Time_Edit' value='Publish Now' class='select_option' style='border: none; font-size: 15px;'>
                ...
                <div class='content popup_set_time' style='width: 300px; height: 310px;'>
                    ...
                    <div class='content_body popup_set_time_body'>
                        ...
                        <div class='popup_form'>
                            ...
                            <input type='submit' value='Set' name='Pending_JV_With_Time_Edit' class='update_btn' style='border: none;'>
