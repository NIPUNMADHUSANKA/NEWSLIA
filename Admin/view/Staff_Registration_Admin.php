        ...
        <?php
          ...
          if($staff_state_results){
              foreach($staff_state_results as $staff_state_result){
                ...
                $staff_state_actor_sql = "SELECT * FROM system_actor WHERE System_Actor_Id = '$ID' AND 	Position = 'A'";
                ...
                if($staff_state_actor_results){
                  foreach($staff_state_actor_results as $staff_state_actor_result){
                            ...
                            echo "
                            <form action = './Staff_Registration_Admin.php' method = 'POST'>
...
<?php
  if(isset($_POST['admin'])){
    ...
    $_SESSION['STAFF_ADMIN_MEMBER'] = $_POST['staffId'];
    
    $_SESSION['STAFF_ADMIN_MEMBER_EMAIL'] = $_POST['staffemail'];

    //$ID = $_SESSION['STAFF_MEMBER'];

    //echo '<script>alert(work)</script>';
    //echo '<script>alert("'.$ID.'")</script>';
    echo '<script type="text/javascript">window.open("./System Staff Registration Confirm Admin.php", "_self");</script>';
  }
?>
